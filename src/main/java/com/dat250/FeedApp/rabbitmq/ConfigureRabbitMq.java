...
import com.dat250.FeedApp.rabbitmq.consumer.ReceiveMessageHandler;
...
public class ConfigureRabbitMq {
    ...
    public static final String EXCHANGE_NAME = "gunnarexchange";
    public static final String QUEUE_NAME = "gunnarqueue";

    @Bean
    Queue createQueue() {
        return new Queue("gunnarqueue", false);
    }
